...
namespace KnightlyTales
{
	...
	public class GameManager : MonoBehaviour
	{
		...
		private GameObject slideOutCanvas;
		...
		void HideLevelImage ()
		{
			...
			slideOutCanvas.SetActive (false);
		...
		public void GameOver ()
		{
			...
			questText.text = "After " + level + " quests, you died.";
		...
		{
			items = new List<Item> (new Item[inventory.Items.Count]);
