	...
	public class Joystick : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler
	{
		...
		public void OnDrag(PointerEventData data)
		{
			...
			if (delta > MovementRange) {
				deltaX = (int)(((double)MovementRange/delta)*deltaX);
				deltaY = (int)(((double)MovementRange/delta)*deltaY);
			}
			newPos.x = deltaX;
			newPos.y = deltaY;
			...
			/*if (m_UseX)
			{
				deltaX = (int)(data.position.x - m_StartPos.x);
			...
			if (m_UseY)
			{
				int yMovementRange = (int)(Math.Sqrt(MovementRange*MovementRange - deltaX*deltaX));
				deltaY = (int)(data.position.y - m_StartPos.y);
				deltaY = Mathf.Clamp(deltaY, -yMovementRange, yMovementRange);
				newPos.y = deltaY;
			} */
