...
public class TDMap {
    ...
    private void GenerateRandomMass(TileType[,] area, TileType fill, int x_coord, int y_coord, int kFactor, int cFactor, int radius){
		area[x_coord, y_coord] = fill;
		InverseSpiralGeneration (area, fill, x_coord, y_coord, kFactor, cFactor, radius);
	}
